...
const levelsData = [
  {
    id: 'kiva',
    name: 'KiVA (Easy)',
    imageSrc: 'https://placehold.co/400x300/E0E0E0/000000?text=KiVA+Example', // Replace with your k.jpg URL
    caption: '(1) **KiVA** examines generalization to **novel objects** (e.g., rule: 6 new objects decrease by 1 in number). This level primarily tests basic object recognition and simple rule application to new instances of familiar categories, focusing on the ability to apply a learned rule to objects not seen during training.'
  },
  {
    id: 'kiva-functions',
    name: 'KiVA-functions (Moderate)',
    imageSrc: 'https://placehold.co/400x300/D0D0D0/000000?text=KiVA-functions+Example', // Replace with your kf.jpg URL
    caption: '(2) **KiVA-functions** examines generalization to **novel values of visual features through functional inference** (e.g., rule: new number of new objects decrease by 1 in number). Here, the model must infer a function that applies to a range of feature values (like number or size), not just specific objects, demonstrating an understanding of the underlying relationship.'
  },
  {
    id: 'kiva-functions-compositionality',
    name: 'KiVA-functions-compositionality (Difficult)',
    imageSrc: 'https://placehold.co/400x300/C0C0C0/000000?text=KiVA-compositionality+Example', // Replace with your kfc.jpg URL
    caption: '(3) **KiVA-functions-compositionality** examines generalization to **novel values and combinations of visual features**, testing functional and compositional reasoning (e.g., rule: new number and new orientation of new objects decrease by 1 in number and rotate by 180 degrees in orientation). This is the most complex level, requiring the model to combine multiple inferred functions and apply them to unseen feature combinations.'
  }
];
  ...
  return (
    <div className="bg-white rounded-2xl shadow-xl overflow-hidden my-8"> {/* Added margin for spacing */}
      ...
      <div className="p-6 sm:p-8 bg-blue-600 text-white text-center rounded-t-2xl">
        <h1 className="text-3xl sm:text-4xl font-bold mb-2">KiVA Difficulty Levels</h1>
